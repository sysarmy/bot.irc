COMMAND_HELP = {
    ...
    "status": "!status <servicio> - Muestra el estado actual y uptime estimado de los ultimos 30 dias. Servicios: atlassian, cloudflare, datadog (US1), digitalocean, discord, github, npm, openai. Ejemplo: !status github",
