COMMAND_HELP = {
    "birras": "!birras — Muestra las próximas AdminBirras y eventos de Sysarmy.",
    "caucho": "!caucho — Muestra la tasa de caución actual.",
    ...
    "dolar": "!dolar [pesos] — Muestra cotizaciones del dólar. Opcionalmente convierte un monto. Ejemplo: !dolar 50000",
    "euro": "!euro — Muestra la cotización actual del euro.",
    "feriadoar": "!feriadoar — Muestra los próximos feriados de Argentina.",
    "feriadocl": "!feriadocl — Muestra los próximos feriados de Chile.",
    "feriadoes": "!feriadoes — Muestra los próximos feriados de España.",
    "feriadomx": "!feriadomx — Muestra los próximos feriados de México.",
    "feriadouy": "!feriadouy — Muestra los próximos feriados de Uruguay.",
    "fulbo": "!fulbo <liga> — Muestra resultados de fútbol. Ligas: PL, BL1, PD, FL1 y SA. Ejemplo: !fulbo PL",
    "rank": "!rank — Muestra el ranking general de karma.",
    "karma": "!karma <palabra o usuario> — Consulta su karma. Ejemplo: !karma nachi",
    "kgivers": "!kgivers — Muestra quiénes dieron más karma.",
    "kgiven": "!kgiven <usuario> — Consulta cuánto karma dio un usuario. Ejemplo: !kgiven nachi",
    "pesos": "!pesos <monto> — Convierte pesos argentinos a dólares. Ejemplo: !pesos 10000",
    ...
    "ping": "!ping — Comprueba si el bot está respondiendo.",
    "flip": "!flip — Tira una mesa. No requiere argumentos.",
    "shrug": "!shrug — Responde con el clásico encogimiento de hombros.",
...
def help_message(argument: str = "") -> str:
    ...
    if detail:
        return detail
    return f"No hay ayuda para '{command}'. Ejecutá !help para ver los comandos disponibles."
