...
async def helpfunctx(ctx, texto):
    ...
    if texto is None:
        ...
        await ctx.send(
            "Pone !feriadouy !feriadoar !feriadocl !feriadoes !feriadomx y te da los proximos feriados para el pais seleccionado. No requiere argumentos"
        )
        ...
        await ctx.send(
            "Pone !nerdearla para consultar charlas subidas a YouTube y agenda de Nerdearla en base a un texto. Ej: '!nerdearla kubernetes'"
        )
